...
def group(record):
  ...
  if True and record.zdList[0] in adrg_zd:
    ...
    if MDCC_DRG.CS13_group(record):
      return 'CS13'

    if MDCC_DRG.CS15_group(record):
      return 'CS15'
