...
def group(record):
  ...
  if True and record.zdList[0] in adrg_zd:
    ...
    if MDCI_DRG.IT2B_group(record):
      return 'IT2B'

    if MDCI_DRG.IT2C_group(record):
      return 'IT2C'
