...
def group(record):
  ...
  if True and record.zdList[0] in adrg_zd:
    ...
    if MDCT_DRG.TU13_group(record):
      return 'TU13'

    if MDCT_DRG.TU15_group(record):
      return 'TU15'
